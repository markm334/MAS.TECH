  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sans",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-warm-glow)]",
        ghost: "hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-[image:var(--gradient-warm)] text-secondary-foreground shadow-[var(--shadow-elevated)] hover:shadow-[var(--shadow-warm-glow)] hover:scale-105 transform",
        ...
        cta: "bg-secondary text-secondary-foreground shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-warm-glow)] hover:scale-105 transform",
        "cta-primary": "bg-primary text-primary-foreground shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-glow)] hover:scale-105 transform",
